...
class NavigationIconClickListener @JvmOverloads internal constructor(
    ...
    override fun onClick(view: View) {
        ...
        val translateX = height - context.resources.getDimensionPixelSize(R.dimen.shr_product_grid_reveal_height)

        val animator = ObjectAnimator.ofFloat(sheet, "translationX", (if (backdropShown) translateX else 0).toFloat())
